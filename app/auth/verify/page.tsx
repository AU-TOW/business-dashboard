      ...
      <div style={styles.verifyBox}>
        {status === 'verifying' && (
          <div style={styles.content}>
            ...
            <p style={styles.subtitle}>Please wait while we verify your link...</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div style={styles.content}>
            ...
            <h1 style={styles.successTitle}>Welcome Back!</h1>
            <p style={styles.subtitle}>
              Signed in as <strong>{businessName}</strong>
            </p>
        ...
        {status === 'error' && (
          <div style={styles.content}>
            ...
            <h1 style={styles.errorTitle}>Sign In Failed</h1>
