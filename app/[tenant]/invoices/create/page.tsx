    ...
    const fetchBusinessSettings = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Set default notes if not already set (only for new invoices)
          ...
          <div style={styles.formGrid} className="form-grid">
            <div style={styles.formGroup}>
              ...
              <input
                ...
                style={{
                  ...styles.input,
                  ...(mode === 'create' && !manualInvoiceNumber ? { background: '#f1f5f9', color: colors.primary, fontWeight: '600' } : {})
                }}
