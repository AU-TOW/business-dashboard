    ...
    <div style={styles.container}>
      <div style={styles.header} className="dashboard-header">
        <div style={styles.headerLeft} className="header-left">
          {branding.logoUrl && (
            <img src={branding.logoUrl} alt={branding.businessName} style={styles.logo} className="dashboard-logo" />
          )}
          <div style={styles.headerText}>
            <h1 style={styles.title} className="dashboard-title">{branding.businessName} Dashboard</h1>
        ...
        <div style={styles.headerButtons}>
          ...
          <button onClick={() => router.push(paths.jotter)} style={styles.jotterBtn}>
            ✍️ Jotter
          </button>
          <button onClick={() => router.push(paths.notes)} style={styles.notesBtn}>
            📝 Notes
          </button>
          <button onClick={() => router.push(paths.assessments)} style={styles.assessmentsBtn}>
            Assessments
          </button>
          <button onClick={() => router.push(paths.bookings)} style={styles.newBookingBtn}>
            + New Booking
          </button>
        </div>
      </div>
